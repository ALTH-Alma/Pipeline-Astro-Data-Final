...
void InitVariables() {
  init_var("ALPHA", (char*)&ALPHA, REAL, NO, "0.00120");
  init_var("AMAX", (char*)&AMAX, REAL, NO, "0.30");
  init_var("AMBIPOLARDIFFUSIONCOEFF", (char*)&AMBIPOLARDIFFUSIONCOEFF, REAL, NO, "0.0");
  init_var("AMIN", (char*)&AMIN, REAL, NO, "0.001");
  ...
  init_var("CUTOFF", (char*)&CUTOFF, REAL, NO, "2.08");
  init_var("DAMPINGZONE", (char*)&DAMPINGZONE, REAL, NO, "1.15");
  init_var("DT", (char*)&DT, REAL, NO, "0.314159265359");
  init_var("ECCENTRICITY", (char*)&ECCENTRICITY, REAL, NO, "0.06690558160889261");
  ...
  init_var("FLARINGINDEX", (char*)&FLARINGINDEX, REAL, NO, "0.44");
  ...
  init_var("GAMMADUST", (char*)&GAMMADUST, REAL, NO, "3.5");
  ...
  init_var("MASSTAPER", (char*)&MASSTAPER, REAL, NO, "20.0");
  init_var("MFACTOR", (char*)&MFACTOR, REAL, NO, "1.0");
  init_var("NINTERM", (char*)&NINTERM, INT, NO, "1369");
  init_var("NOISE", (char*)&NOISE, REAL, NO, "0.0");
  init_var("NSNAP", (char*)&NSNAP, INT, NO, "0");
  init_var("NTOT", (char*)&NTOT, INT, NO, "1369");
  ...
  init_var("OUTPUTDIR", (char*)&OUTPUTDIR, STRING, NO, "@outputs/Alma_outputs_new/sim_19");
  init_var("PERIODICY", (char*)&PERIODICY, BOOL, NO, "0");
  init_var("PERIODICZ", (char*)&PERIODICZ, BOOL, NO, "0");
  init_var("PLANETCONFIG", (char*)&PLANETCONFIG, STRING, NO, "planets/Alma_planets/19.cfg");
  ...
  init_var("RFACTOR", (char*)&RFACTOR, REAL, NO, "10.0");
  init_var("RHO_SOLID", (char*)&RHO_SOLID, REAL, NO, "2.0");
  init_var("ROCHESMOOTHING", (char*)&ROCHESMOOTHING, REAL, NO, "0.0");
  init_var("SEMIMAJORAXIS", (char*)&SEMIMAJORAXIS, REAL, NO, "0.0");
  init_var("SETUP", (char*)&SETUP, STRING, NO, "Alma_Vidal_new");
  init_var("SIGMA0", (char*)&SIGMA0, REAL, NO, "0.00024");
  init_var("SIGMASLOPE", (char*)&SIGMASLOPE, REAL, NO, "-1.13");
  init_var("SPACING", (char*)&SPACING, STRING, NO, "Lin");
  ...
  init_var("YMAX", (char*)&YMAX, REAL, NO, "2.71");
  init_var("YMB", (char*)&YMB, REAL, NO, "0.0");
  init_var("YMC", (char*)&YMC, REAL, NO, "0.0");
  init_var("YMIN", (char*)&YMIN, REAL, NO, "0.39");
